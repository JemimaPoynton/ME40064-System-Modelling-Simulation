function localMassMat = massMat_local_qb(mesh, eID)
% function massMat_local_qb calculates the local mass matix for the element in
% the mesh defined by eID. Uses quadratic basis functions.
%
...
for i = 1:N % Defined directly for speed (to avoid slow for loops)
    ...
    Int02 = Int02 + gq.gsw(i)*psi0(i)*psi2(i)*J;

    Int10 = Int10 + gq.gsw(i)*psi1(i)*psi0(i)*J;
    Int11 = Int11 + gq.gsw(i)*psi1(i)*psi1(i)*J;
    Int12 = Int12 + gq.gsw(i)*psi1(i)*psi2(i)*J;

    Int20 = Int20 + gq.gsw(i)*psi2(i)*psi0(i)*J;
    Int21 = Int21 + gq.gsw(i)*psi2(i)*psi1(i)*J;
    Int22 = Int22 + gq.gsw(i)*psi2(i)*psi2(i)*J;
end

%% Form Matrix
localMassMat = [Int00 Int01 Int02; 
                Int10 Int11 Int12
                Int20 Int21 Int22];